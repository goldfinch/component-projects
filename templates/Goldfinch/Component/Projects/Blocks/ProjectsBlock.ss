        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button
              ...
              data-bs-target="#projectsblock-{$Top.ID}-item-{$ID}"
              aria-expanded="false"
              aria-controls="projectsblock-{$Top.ID}-item-{$ID}"
            >
              $Title
            </button>
          </h2>
          <div
            id="projectsblock-{$Top.ID}-item-{$ID}"
            class="accordion-collapse collapse"
            data-bs-parent="#projectsblock-{$Top.ID}"
          >
